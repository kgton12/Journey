...
namespace Journey.Exception {
    ...
    public class ResourceErrorMessages {
        ...
        /// <summary>
        ///   Consulta uma cadeia de caracteres localizada semelhante a The date you selected for the activity is not within your traver period.
        /// </summary>
        public static string DATE_NOTE_WITHIN_TRAVER_PERIOD {
            get {
                return ResourceManager.GetString("DATE_NOTE_WITHIN_TRAVER_PERIOD", resourceCulture);
            }
        }
        ...
        /// <summary>
        ///   Consulta uma cadeia de caracteres localizada semelhante a The end date of the trip must be later than the start date.
        /// </summary>
